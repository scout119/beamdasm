...
export const TAG_X_REGISTER = 3;
export const TAG_Y_REGISTER = 4;
export const TAG_LABEL = 5;
export const TAG_CHARACTER = 6;
export const TAG_EXT_FLOAT = 7;
export const TAG_EXT_LIST = 8;
